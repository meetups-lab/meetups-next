    ...
    <form>
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base/7 font-semibold text-gray-900">Criar Perfil</h2>
          <p className="mt-1 text-sm/6 text-gray-600">
          Cadastre sua empresa. Essas informações estaram disponíveis no seu site.
          </p>

          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-4">
              <label htmlFor="nomeempresa" className="block text-sm/6 font-medium text-gray-900">
                Nome da empresa
              </label>
              <div className="mt-2">
            ...
            <div className="sm:col-span-4">
              <label htmlFor="segmento" className="block text-sm/6 font-medium text-gray-900">
                Segmento de atuação
              </label>
