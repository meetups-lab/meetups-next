    ...
    <div className="flex h-full flex-col">
      <header className="flex flex-none items-center justify-between border-b border-gray-200 px-6 py-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Sábado</p>
        </div>
      ...
      <div className="isolate flex flex-auto overflow-hidden bg-white">
            ...
            <div className="grid flex-auto grid-cols-1 grid-rows-1">
              ...
              >
                <li className="relative mt-px flex" style={{ gridRow: '74 / span 12' }}>
                  ...
                  >
                    <p className="order-1 font-semibold text-blue-700">Massagem de aromaterapia</p>
                    <p className="text-blue-500 group-hover:text-blue-700">
                      <time dateTime="2022-01-22T06:00">6:00</time>
                    </p>
                  </a>
                </li>
                <li className="relative mt-px flex" style={{ gridRow: '92 / span 30' }}>
                  ...
                  >
                    <p className="order-1 font-semibold text-pink-700">Massagem com pedras quentes</p>
                    <p className="order-1 text-pink-500 group-hover:text-pink-700">
                    Calma da Mente | Massoterapia
                    </p>
                    <p className="text-pink-500 group-hover:text-pink-700">
                      <time dateTime="2022-01-22T07:30">7:30</time>
                    </p>
                  </a>
                </li>
                <li className="relative mt-px flex" style={{ gridRow: '134 / span 18' }}>
                  ...
                  >
                    <p className="order-1 font-semibold text-indigo-700">Massagem esportiva</p>
                    <p className="order-1 text-indigo-500 group-hover:text-indigo-700">Buddha Spa</p>
                    <p className="text-indigo-500 group-hover:text-indigo-700">
                      <time dateTime="2022-01-22T11:00">11:00</time>
                    </p>
                  </a>
                </li>
              </ol>
        ...
        <div className="hidden w-1/2 max-w-md flex-none border-l border-gray-100 px-8 py-10 md:block">
          <div className="flex items-center text-center text-gray-900">
            ...
            >
              <span className="sr-only">Anterior mês</span>
              <ChevronLeftIcon className="size-5" aria-hidden="true" />
            </button>
            <div className="flex-auto text-sm font-semibold">Janeiro 2022</div>
            <button
              type="button"
              className="-m-1.5 flex flex-none items-center justify-center p-1.5 text-gray-400 hover:text-gray-500"
            >
